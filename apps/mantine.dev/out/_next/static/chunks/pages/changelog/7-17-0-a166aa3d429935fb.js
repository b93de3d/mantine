...
`,centered:!0,defaultExpanded:!1,maxWidth:440}},73943:(e,t,n)=>{"use strict";n.d(t,{E:()=>d});var r=n(31085),o=n(90275),i=n(93065),s=n(52022),l=n(23719),a=n(51896),c=n(84097);let d={type:"code",component:function(){let e=(0,l.m)({mode:"uncontrolled",initialValues:{user:{firstName:"",lastName:""}},validate:{user:{[a.N]:e=>e.firstName.trim().length>0&&e.firstName===e.lastName?"First name and last name cannot be the same":null,firstName:(0,c.h)("First name is required"),lastName:(0,c.h)("Last name is required")}}});return(0,r.jsxs)("form",{onSubmit:e.onSubmit(()=>{}),children:[(0,r.jsx)(o.k,{label:"First name",placeholder:"First name",...e.getInputProps("user.firstName")}),(0,r.jsx)(o.k,{label:"Last name",placeholder:"Last name",mt:"md",...e.getInputProps("user.lastName")}),e.errors.user&&(0,r.jsx)(i.E,{c:"red",mt:5,fz:"sm",children:e.errors.user}),(0,r.jsx)(s.$,{type:"submit",mt:"lg",children:"Submit"})]})},code:`
...
`,maxWidth:340,centered:!0}},40691:(e,t,n)=>{"use strict";n.d(t,{b:()=>d});var r=n(31085),o=n(17592),i=n(56051),s=n(52022),l=n(14041),a=n(89571);let c={multiple:!0,accept:"*"},d={type:"code",component:function(){let e=function(e={}){let t={...c,...e},[n,r]=(0,l.useState)(function(e){if(!e)return null;if(e instanceof FileList)return e;let t=new DataTransfer;for(let n of e)t.items.add(n);return t.files}(t.initialFiles)),o=(0,l.useRef)(null),i=(0,l.useCallback)(e=>{let n=e.target;n?.files&&(r(n.files),t.onChange?.(n.files))},[t.onChange]),s=(0,l.useCallback)(()=>{o.current?.remove(),o.current=function(e){if("undefined"==typeof document)return null;let t=document.createElement("input");return t.type="file",e.accept&&(t.accept=e.accept),e.multiple&&(t.multiple=e.multiple),e.capture&&(t.capture=e.capture),e.directory&&(t.webkitdirectory=e.directory),t.style.display="none",t}(t),o.current&&(o.current.addEventListener("change",i,{once:!0}),document.body.appendChild(o.current))},[t,i]);(0,a.o)(()=>(s(),()=>o.current?.remove()),[]);let d=(0,l.useCallback)(()=>{r(null),t.onChange?.(null)},[t.onChange]);return{files:n,open:(0,l.useCallback)(()=>{t.resetOnOpen&&d(),s(),o.current?.click()},[t.resetOnOpen,d,s]),reset:d}}(),t=Array.from(e.files||[]).map(e=>(0,r.jsx)(o.B.Item,{children:e.name},e.name));return(0,r.jsxs)("div",{children:[(0,r.jsxs)(i.Y,{children:[(0,r.jsx)(s.$,{onClick:e.open,children:"Pick files"}),t.length>0&&(0,r.jsx)(s.$,{variant:"default",onClick:e.reset,children:"Reset"})]}),t.length>0&&(0,r.jsx)(o.B,{mt:"lg",children:t})]})},code:`
...
`}},84097:(e,t,n)=>{"use strict";function r(e){let t=e||!0;return e=>"string"==typeof e?e.trim().length>0?null:t:Array.isArray(e)?e.length>0?null:t:null==e||!1===e?t:null}n.d(t,{h:()=>r})}},e=>{var t=t=>e(e.s=t);e.O(0,[67456,85954,23719,90636,46593,38792],()=>t(96037)),_N_E=e.O()}]);